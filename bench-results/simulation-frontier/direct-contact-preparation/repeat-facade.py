...
out=root/'bench-results/simulation-frontier/direct-contact-preparation/facade-repeats';out.mkdir(exist_ok=True)
results=[]
for trial in range(1,4):
 for arm in ('baseline','final'):
  ...
  cmd=[str(binary),'a_shot_damages_the_facade_without_starting_a_collapse','--exact','--nocapture','--test-threads=1']
