declare module '*dune/live-geometry.mjs' {
 ...
 export class LiveAssembly { constructor(group: any, materials: any); update(model: any, explosion: number, hidden: Set<string>): void; bindMotion(): void; applyMotion(rig: any): void; dispose(): void; }
}
